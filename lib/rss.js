...
const FEEDS = {
  ...
  sindh: [
    ...
    // BBC has no dedicated Sindh feed; its Urdu feed is safely passed through
    // the same strict Sindh headline/description filter as every other source.
    { url: 'https://feeds.bbci.co.uk/urdu/rss.xml', source: 'BBC Urdu' },
...
export const SOURCES = [
  'BBC Urdu', 'Dawn', 'Geo News', 'Express Tribune', 'ARY News',
