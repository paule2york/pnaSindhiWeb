...
async function viaGemini(text, from) {
  ...
  const prompt =
    'You are a professional Sindhi newspaper translator. Translate to natural, journalistic Sindhi language as written in Sindhi newspapers like Kawish and Ibrat. Rules:\\n' +
    ...
    '3. CRITICAL HEADLINE RULE: Headlines for past events MUST use past perfective endings (ڪيو, ويو, چيو, ٿيو for masculine; ڪئي, وئي, چئي, ٿي for feminine). Never use present tense ٿو or ٿي at the end. Sindhi newspaper style requires this.\\n' +
...
const PROVIDERS = [viaAzure, viaGemini, viaGoogleGtx, viaGoogleClients5, viaLingva];
