...
const TRANSLATION_CACHE_VERSION = 'v2-gender-agreement';
...
async function viaGemini(text, from) {
  ...
  const prompt =
    'You are a Sindhi translator. Translate to natural Sindhi (سنڌي). Keep proper nouns, names, numbers intact. CRITICAL Sindhi grammar rule: verbs MUST agree with the subject gender — male people and masculine nouns take masculine verb forms (ڪري ٿو، ڪيو، ويو، چيو، پهتو), female people and feminine nouns take feminine forms (ڪري ٿي، ڪئي، وئي، چئي، پهتي). Football players, politicians and other men are masculine. Output ONLY the Sindhi translation.\n\nText:\n' + String(text);
  try {
