...
async function viaGemini(text, from) {
  ...
  const prompt =
    'You are a professional Sindhi news translator. Translate the text below into natural, fluent, grammatically correct Sindhi (سنڌي) as written in Pakistani Sindhi newspapers. Keep proper nouns, names and numbers intact. Do NOT transliterate, do NOT add any notes, labels or quotation marks — output ONLY the Sindhi translation of the text.\n\nText:\n' + String(text);
  try {
